...
import { facilityTypeColumns } from './column';

interface FacilityTypeTableProps {
  data: facilityTypeState[];
}

export default function FacilityTypeTable({ data }: FacilityTypeTableProps) {
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {table.getRowModel().rows.length > 0 ? (
              ...
              <tr>
                <td
                  colSpan={facilityTypeColumns.length}
