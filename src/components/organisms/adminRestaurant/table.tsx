...
import { useAdminRestoColumns } from './column'

interface AdminRestoTableProps {
  data: adminRestoListState[]
}

export default function AdminRestoTable({ data }: AdminRestoTableProps) {
  const [sorting, setSorting] = useState<SortingState>([])
  const columns = useAdminRestoColumns()
