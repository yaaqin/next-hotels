...
import { usePartnerProposalColumns } from './column'

interface PartnerProposalTableProps {
  data: partnerProposalListState[]
}

export default function PartnerProposalTable({ data }: PartnerProposalTableProps) {
  const [sorting, setSorting] = useState<SortingState>([])
  const columns = usePartnerProposalColumns()
